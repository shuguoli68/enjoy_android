class SystemTreeEntity {
	...
	SystemTreeEntity.fromJson(Map<String, dynamic> json) {
		if (json['data'] != null) {
			data = new List<SystemTreeData>();(json['data'] as List).forEach((v) { data.add(new SystemTreeData.fromJson(v)); });
		}
...
class SystemTreeData {
	...
	SystemTreeData.fromJson(Map<String, dynamic> json) {
		...
		if (json['children'] != null) {
			children = new List<SystemTreeDatachild>();(json['children'] as List).forEach((v) { children.add(new SystemTreeDatachild.fromJson(v)); });
		}
		name = json['name'];
